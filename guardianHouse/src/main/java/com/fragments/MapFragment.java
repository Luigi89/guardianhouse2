...
import com.projects.guardianhouse.MainActivity;
...
//		int i = android.R.anim.slide_out_right;
	...
	public void setUpMap() {
		...
		try {
			...
			drawingView.setColor(getResources().getColor(R.color.bianco));
			drawingView.setPolylineColor(getResources().getColor(R.color.bianco));
